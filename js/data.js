...
/* ================================================================
   ...
   ================================================================ */
var MEGA_EVO_DATA = [
  // fid = PokeAPI form ID → used for official-artwork URL (10033+ in national dex order)
  ...
  {id:15, name:'beedrill',   megaName:'Mega Beedrill',        types:['bug','poison'],       ability:'Adaptability',  bst:495, stone:'Beedrillite',     sdn:'beedrillmega',   fid:10037},
  {id:18, name:'pidgeot',    megaName:'Mega Pidgeot',         types:['normal','flying'],    ability:'No Guard',      bst:579, stone:'Pidgeotite',      sdn:'pidgeotmega',    fid:10038},
  {id:65, name:'alakazam',   megaName:'Mega Alakazam',        types:['psychic'],            ability:'Trace',         bst:590, stone:'Alakazite',       sdn:'alakazammega',   fid:10039},
  {id:80, name:'slowbro',    megaName:'Mega Slowbro',         types:['water','psychic'],    ability:'Shell Armor',   bst:590, stone:'Slowbronite',     sdn:'slowbromega',    fid:10040},
  {id:94, name:'gengar',     megaName:'Mega Gengar',          types:['ghost','poison'],     ability:'Shadow Tag',    bst:600, stone:'Gengarite',       sdn:'gengarmega',     fid:10041},
  {id:115,name:'kangaskhan', megaName:'Mega Kangaskhan',      types:['normal'],             ability:'Parental Bond', bst:590, stone:'Kangaskhanite',   sdn:'kangaskhanmega', fid:10042},
  {id:127,name:'pinsir',     megaName:'Mega Pinsir',          types:['bug','flying'],       ability:'Aerilate',      bst:600, stone:'Pinsirite',       sdn:'pinsirmega',     fid:10043},
  {id:130,name:'gyarados',   megaName:'Mega Gyarados',        types:['water','dark'],       ability:'Mold Breaker',  bst:640, stone:'Gyaradosite',     sdn:'gyaradosmega',   fid:10044},
  {id:142,name:'aerodactyl', megaName:'Mega Aerodactyl',      types:['rock','flying'],      ability:'Tough Claws',   bst:615, stone:'Aerodactylite',   sdn:'aerodactylmega', fid:10045},
  {id:150,name:'mewtwo',     megaName:'Mega Mewtwo X',        types:['psychic','fighting'], ability:'Steadfast',     bst:780, stone:'Mewtwonite X',    sdn:'mewtwomegax',    fid:10046, formB:{megaName:'Mega Mewtwo Y',types:['psychic'],ability:'Insomnia',bst:780,stone:'Mewtwonite Y',sdn:'mewtwomegay',fid:10047}},
  {id:181,name:'ampharos',   megaName:'Mega Ampharos',        types:['electric','dragon'],  ability:'Mold Breaker',  bst:610, stone:'Ampharosite',     sdn:'ampharosmega',   fid:10048},
  {id:208,name:'steelix',    megaName:'Mega Steelix',         types:['steel','ground'],     ability:'Sand Force',    bst:610, stone:'Steelixite',      sdn:'steelixmega',    fid:10049},
  {id:212,name:'scizor',     megaName:'Mega Scizor',          types:['bug','steel'],        ability:'Technician',    bst:600, stone:'Scizorite',       sdn:'scizormega',     fid:10050},
  {id:214,name:'heracross',  megaName:'Mega Heracross',       types:['bug','fighting'],     ability:'Skill Link',    bst:600, stone:'Heracronite',     sdn:'heracrossmega',  fid:10051},
  {id:228,name:'houndoom',   megaName:'Mega Houndoom',        types:['dark','fire'],        ability:'Solar Power',   bst:580, stone:'Houndoominite',   sdn:'houndoommega',   fid:10052},
  {id:248,name:'tyranitar',  megaName:'Mega Tyranitar',       types:['rock','dark'],        ability:'Sand Stream',   bst:700, stone:'Tyranitarite',    sdn:'tyranitarmega',  fid:10053},
  {id:254,name:'sceptile',   megaName:'Mega Sceptile',        types:['grass','dragon'],     ability:'Lightning Rod', bst:630, stone:'Sceptilite',      sdn:'sceptilemega',   fid:10054},
  {id:257,name:'blaziken',   megaName:'Mega Blaziken',        types:['fire','fighting'],    ability:'Speed Boost',   bst:630, stone:'Blazikenite',     sdn:'blazikenmega',   fid:10055},
  {id:260,name:'swampert',   megaName:'Mega Swampert',        types:['water','ground'],     ability:'Swift Swim',    bst:635, stone:'Swampertite',     sdn:'swampertmega',   fid:10056},
  {id:282,name:'gardevoir',  megaName:'Mega Gardevoir',       types:['psychic','fairy'],    ability:'Pixilate',      bst:618, stone:'Gardevoirite',    sdn:'gardevoirmega',  fid:10057},
  {id:302,name:'sableye',    megaName:'Mega Sableye',         types:['dark','ghost'],       ability:'Magic Bounce',  bst:480, stone:'Sableyite',       sdn:'sableyemega',    fid:10058},
  {id:303,name:'mawile',     megaName:'Mega Mawile',          types:['steel','fairy'],      ability:'Huge Power',    bst:480, stone:'Mawilite',        sdn:'mawilemega',     fid:10059},
  {id:306,name:'aggron',     megaName:'Mega Aggron',          types:['steel'],              ability:'Filter',        bst:630, stone:'Aggronite',       sdn:'aggronmega',     fid:10060},
  {id:308,name:'medicham',   megaName:'Mega Medicham',        types:['fighting','psychic'], ability:'Pure Power',    bst:510, stone:'Medichamite',     sdn:'medichammega',   fid:10061},
  {id:310,name:'manectric',  megaName:'Mega Manectric',       types:['electric'],           ability:'Intimidate',    bst:575, stone:'Manectite',       sdn:'manectricmega',  fid:10062},
  {id:319,name:'sharpedo',   megaName:'Mega Sharpedo',        types:['water','dark'],       ability:'Strong Jaw',    bst:560, stone:'Sharpedonite',    sdn:'sharpedomega',   fid:10063},
  {id:323,name:'camerupt',   megaName:'Mega Camerupt',        types:['fire','ground'],      ability:'Sheer Force',   bst:560, stone:'Cameruptite',     sdn:'cameruptmega',   fid:10064},
  {id:334,name:'altaria',    megaName:'Mega Altaria',         types:['dragon','fairy'],     ability:'Pixilate',      bst:590, stone:'Altarianite',     sdn:'altariamega',    fid:10065},
  {id:354,name:'banette',    megaName:'Mega Banette',         types:['ghost'],              ability:'Prankster',     bst:555, stone:'Banettite',       sdn:'banettemega',    fid:10066},
  {id:359,name:'absol',      megaName:'Mega Absol',           types:['dark'],               ability:'Magic Bounce',  bst:565, stone:'Absolite',        sdn:'absolmega',      fid:10067},
  {id:362,name:'glalie',     megaName:'Mega Glalie',          types:['ice'],                ability:'Refrigerate',   bst:580, stone:'Glalitite',       sdn:'glaliemega',     fid:10068},
  {id:373,name:'salamence',  megaName:'Mega Salamence',       types:['dragon','flying'],    ability:'Aerilate',      bst:700, stone:'Salamencite',     sdn:'salamencemega',  fid:10069},
  {id:376,name:'metagross',  megaName:'Mega Metagross',       types:['steel','psychic'],    ability:'Tough Claws',   bst:700, stone:'Metagrossite',    sdn:'metagrossmega',  fid:10070},
  {id:380,name:'latias',     megaName:'Mega Latias',          types:['dragon','psychic'],   ability:'Levitate',      bst:700, stone:'Latiasite',       sdn:'latiasmega',     fid:10071},
  {id:381,name:'latios',     megaName:'Mega Latios',          types:['dragon','psychic'],   ability:'Levitate',      bst:700, stone:'Latiosite',       sdn:'latiosmega',     fid:10072},
  {id:384,name:'rayquaza',   megaName:'Mega Rayquaza',        types:['dragon','flying'],    ability:'Delta Stream',  bst:780, stone:'Dragon Ascent',   sdn:'rayquazamega',   fid:10073},
  {id:428,name:'lopunny',    megaName:'Mega Lopunny',         types:['normal','fighting'],  ability:'Scrappy',       bst:580, stone:'Lopunnite',       sdn:'lopunnymega',    fid:10074},
  {id:448,name:'lucario',    megaName:'Mega Lucario',         types:['fighting','steel'],   ability:'Adaptability',  bst:625, stone:'Lucarionite',     sdn:'lucariomega',    fid:10075},
  {id:460,name:'abomasnow',  megaName:'Mega Abomasnow',       types:['grass','ice'],        ability:'Snow Warning',  bst:594, stone:'Abomasite',       sdn:'abomasnowmega',  fid:10076},
  {id:475,name:'gallade',    megaName:'Mega Gallade',         types:['psychic','fighting'], ability:'Inner Focus',   bst:618, stone:'Galladite',       sdn:'gallademega',    fid:10077},
  {id:531,name:'audino',     megaName:'Mega Audino',          types:['normal','fairy'],     ability:'Healer',        bst:545, stone:'Audinite',        sdn:'audinomega',     fid:10078},
  {id:719,name:'diancie',    megaName:'Mega Diancie',         types:['rock','fairy'],       ability:'Magic Bounce',  bst:700, stone:'Diancite',        sdn:'dianciemega',    fid:10079},
  // ── SPECJALNE FORMY ──
