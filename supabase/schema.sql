...
-- Sprzedaz zlapanych Pokemonow Kupcowi — niewielki, dodatkowy dochod (nie glowne
-- zrodlo bogacenia sie, patrz brief sekcja 3). Stawka = f(poziom, rzadkosc), gdzie
-- rzadkosc = odwrotnosc base_catch_rate (nizszy catch_rate w grach Pokemon = rzadszy
-- gatunek). Blokada sprzedazy ostatniego posiadanego Pokemona (nie chcemy zostawiac
-- gracza bez zadnego stworka).
...
-- Wybor regionu startowego (jednorazowy, jak tutorial) — na razie tylko Kanto ma
-- realne dane (startery/dzikie spawny), reszta regionow to zapowiedz w UI (brief
-- pkt 6/9: "rozbic na osobne etapy region po regionie").
